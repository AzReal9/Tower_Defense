...
public class TileManager {
	...
	private void createTiles() {
		...
		tiles.add(ROAD = new Tile(getSprite(8, 0), id++, "ROAD"));
                tiles.add(BL_WATER_CORNER = new Tile(ImgFix.buildImg(getImg(0, 0, 5, 0)), id++, "BL Water Corner"));
                tiles.add(TL_WATER_CORNER = new Tile(ImgFix.getBuildRotImg(getImg(0, 0, 5, 0), 90, 1), id++, "TL Water Corner"));
		...
		tiles.add(
				TL_WATER_CORNER = new Tile(ImgFix.getBuildRotImg(getImg(0, 0, 5, 0), 90, 1), id++, "TL_Water_Corner"));

		tiles.add(TR_WATER_CORNER = new Tile(ImgFix.getBuildRotImg(getImg(0, 0, 5, 0), 180, 1), id++,
				"TL_Water_Corner"));

		tiles.add(BR_WATER_CORNER = new Tile(ImgFix.getBuildRotImg(getImg(0, 0, 5, 0), 270, 1), id++,
				"TL_Water_Corner"));
