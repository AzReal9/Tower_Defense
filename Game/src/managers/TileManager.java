...
public class TileManager {
	...
	private void createTiles() {
		...
		beaches.add(T_WATER = new Tile(ImgFix.buildImg(getImg(0, 0, 6, 0)), id++, "T_Water"));
		beaches.add(R_WATER = new Tile(ImgFix.getBuildRotImg(getImg(0, 0, 6, 0), 90, 1), id++, "R_Water"));
		beaches.add(B_WATER = new Tile(ImgFix.getBuildRotImg(getImg(0, 0, 6, 0), 180, 1), id++, "B_Water"));
		beaches.add(L_WATER = new Tile(ImgFix.getBuildRotImg(getImg(0, 0, 6, 0), 270, 1), id++, "L_Water"));

		islands.add(TL_ISLE = new Tile(ImgFix.buildImg(getImg(0, 0, 4, 0)), id++, "TL_Isle"));
		islands.add(TR_ISLE = new Tile(ImgFix.getBuildRotImg(getImg(0, 0, 4, 0), 90, 1), id++, "TR_Isle"));
		islands.add(BR_ISLE = new Tile(ImgFix.getBuildRotImg(getImg(0, 0, 4, 0), 180, 1), id++, "BR_Isle"));
		islands.add(BL_ISLE = new Tile(ImgFix.getBuildRotImg(getImg(0, 0, 4, 0), 270, 1), id++, "BL_Isle"));
